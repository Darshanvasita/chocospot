    ...
    <div className=' flex-1 flex flex-col-reverse gap-3 sm:flex-row'>
      ...
      <div className=' flex-1'>
          ...
          <p className='mt-5 text-gray-500 md:w-4/5'>{productData.description}</p>
              ...
              <button onClick={()=>addToCart(productData._id)} className='bg-black text-white px-8 py-3 mt-4 text-sm active:bg-gray-700'>ADD TO CART</button>
      ...
      {/* Descripsion And Review Section */}
      <div className='mt-20'>
        <div className=' flex'>
              <b className='border border-gray-100 px-5 py-3 text-sm'>Descripsion</b>
